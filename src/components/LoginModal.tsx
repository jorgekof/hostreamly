  ...
  const handleSignUp = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (errorObj.response?.status === 409) {
        ...
        setError(errorObj.response?.data?.message || 'Error al crear la cuenta')
      }
    } finally {
      setLoading(false)
    }
    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-md">
        <DialogHeader className="text-center space-y-2">
          ...
          <DialogTitle className="text-2xl font-bold">Acceso</DialogTitle>
          <p className="text-muted-foreground">Para continuar en Hostreamly.com</p>
        </DialogHeader>
        ...
        <div className="space-y-4">
          ...
          <div className="text-center text-sm space-y-2">
            <p className="text-muted-foreground">
              ...
              y reconoce haber recibido nuestra{' '}
